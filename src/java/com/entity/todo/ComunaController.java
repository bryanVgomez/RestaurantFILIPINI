...
import com.entity.todo.util.JsfUtil.PersistAction;
...
public class ComunaController implements Serializable {
    ...
    @EJB
    private com.entity.todo.ComunaFacade ejbFacade;
    ...
    private ComunaFacade getFacade() {
        return ejbFacade;
    }
    ...
    public Comuna getComuna(java.lang.Integer id) {
